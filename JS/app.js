...
excercise.forEach((excercise) => {
  out += `
  <div class = "excercise-item">
          <div class = "excercise-img">
              <img src = "${excercise.img}" alt = "excercise">
          </div>
          <div class = "excercise-name">
              <h3>${excercise.title}</h3>
              <p class = "excercise-description">"${excercise.description}"</p>
              <a href = "${excercise.link}" class = "excercise-btn">Посмотреть видео</a>
          </div>
   </div>
...
function liveSearch() {
  let cards = document.querySelectorAll(".excercise-item");
